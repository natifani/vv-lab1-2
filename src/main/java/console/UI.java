...
public class UI {
    ...
    public void uiSaveHomework() {
        try {
            ...
            System.out.println("Invalid startline or deadline value! \n");
        } catch (ValidationException ve) {
            System.out.println(ve.getMessage());
        }
    ...
    public void uiSaveGrade() {
        try {
            ...
            System.out.println("Invalid grade or delivery week value! \n ");
        } catch (ValidationException ve) {
            System.out.println(ve.getMessage());
        }
    }
    ...
    public void uiUpdateStudent() {
        try {
            ...
            System.out.println("Newgroup value is invalid! \n");
        } catch (ValidationException ve) {
            System.out.println(ve.getMessage());
        }
    }
    ...
    public void uiExtendDeadline() {
        try {
            ...
            System.out.println("Number of weeks value is invalid! \n");
        }
    }
